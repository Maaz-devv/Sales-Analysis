...
Below is the Overview page from the PowerBI dashboard and more examples are included throughout the report. The entire interactive dashboard can be downloaded [here](https://github.com/your-Maaz-devv/Sales-Analysis/blob/main/Ecommerce Project.pbix`?raw=true)
